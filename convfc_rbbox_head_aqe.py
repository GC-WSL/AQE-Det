...
from .rotated_bbox_head_aqe import RotatedBBoxHeadAQE


@ROTATED_HEADS.register_module()
class RotatedConvFCBBoxHeadAQE(RotatedBBoxHeadAQE):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(RotatedConvFCBBoxHeadAQE, self).__init__(
...
@ROTATED_HEADS.register_module()
class RotatedShared2FCBBoxHeadAQE(RotatedConvFCBBoxHeadAQE):
    """Shared2FC RBBox head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RotatedShared2FCBBoxHeadAQE, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
